...
Al termine delle attivitá di implementazione, il Service Provider deve effettuare dei test in ambiente di pre-produzione volti alla verifica della corretta funzionalitá del servizio e produrre opportune evidenze in formato immagine (screenshot). Tali evidenze devono essere caricate sul `portale di federazione erogatori di sevizi <https://federazione.servizicie.interno.gov.it>`__ al fine di rendere possibile lo svolgimento delle necessarie verifiche tecniche ad opera del personale del Poligrafico incaricato. 
